...
public class ObjectFactory {
    ...
    private final static QName _CarmaRecord_QNAME = new QName("http://edims.corepoint.com/carma", "carmaRecord");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://edims.corepoint.com/carma", name = "carmaRecord")
